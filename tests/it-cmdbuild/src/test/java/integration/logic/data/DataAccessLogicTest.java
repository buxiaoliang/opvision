...
public class DataAccessLogicTest extends IntegrationTestBase {
	...
	public void shouldPaginateSuccessfully() throws Exception {
		...
		// when
		final Iterable<Card> firstPageOfCards = dataAccessLogic
				.fetchCards(newClass.getIdentifier().getLocalName(), createQueryOptions(3, 0, null, null)).elements();
		final Iterable<Card> secondPageOfCards = dataAccessLogic
				.fetchCards(newClass.getIdentifier().getLocalName(), createQueryOptions(3, 3, null, null)).elements();
	...
	public void shouldFetchCardsWithAndConditionsInFilter() throws Exception {
		...
		// when
		final Iterable<Card> fetchedCards = dataAccessLogic
				.fetchCards(newClass.getIdentifier().getLocalName(), createQueryOptions(10, 0, null, filterObject))
				.elements();
