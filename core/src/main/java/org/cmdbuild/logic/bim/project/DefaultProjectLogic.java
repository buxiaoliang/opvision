...
public class DefaultProjectLogic implements ProjectLogic {
	...
	private static final Function<PersistenceProject, Project> PERSISTENCE_TO_LOGIC_PROJECT =
			new Function<PersistenceProject, Project>() {
				@Override
	...
	private static final Function<Project, BimFacadeProject> LOGIC_TO_BIM_PROJECT =
			new Function<ProjectLogic.Project, BimFacade.BimFacadeProject>() {
				@Override
	...
	private static final Function<Project, PersistenceProject> LOGIC_TO_PERSISTENCE_PROJECT =
			new Function<Project, PersistenceProject>() {
