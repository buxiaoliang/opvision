...
import org.cmdbuild.scheduler.quartz.SpringIntegrationUtils4Scheduler;
...
public class QuartzSchedulerServiceTestClustering {
...
//				false, getDefaultStandAloneConfigurationProperties()/*(new SchedulerProperties()).getStandaloneProperties()*/);
	...
	private void cleanDB() {
		String sqlCleanQuartzTables = "begin; " + 
						...
						"commit;"
						;
		DataSource ds = SpringIntegrationUtils4Scheduler.applicationContext().getBean(DataSource.class);
		JdbcTemplate template = new JdbcTemplate(ds);
		template.update(sqlCleanQuartzTables);
...
//		final Trigger timeout = OneTimeTrigger.at(afterMillis(POLLING_TIMEOUT));
