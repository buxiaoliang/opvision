...
abstract class AbstractWebservice implements ApplicationContextAware {
	...
	protected DataAccessLogicHelper dataAccessLogicHelper() {
		final DataAccessLogicHelper helper = new DataAccessLogicHelper( //
				...
				applicationContext.getBean(WebServiceDataAccessLogic.BEAN, DataAccessLogic.class), //
				applicationContext.getBean(WebserviceWorkflowLogicBuilder.class).build(), //
	...
	protected DataAccessLogic userDataAccessLogic() {
		return applicationContext.getBean(UserDataAccessLogic.BEAN, DataAccessLogic.class);
	}
