...
public class PrivateImpl extends AbstractWebservice implements Private {
	...
	@Override
	public ClassSchema getClassSchemaByName(final String name, final boolean includeAttributes) {
		return dataAccessLogicHelper().getClassSchema(name, includeAttributes);
	}

	@Override
	public ClassSchema getClassSchemaById(final long id, final boolean includeAttributes) {
	...
	public String createSession() {
		return sessionLogic().getCurrent();
	}
