...
public interface Private {
	...
	Card getCard(@WebParam(name = "className") String className, @WebParam(name = "cardId") Integer cardId,
			@WebParam(name = "attributeList") Attribute[] attributeList);

	CardList getCardHistory(@WebParam(name = "className") String className, @WebParam(name = "cardId") int cardId,
			@WebParam(name = "limit") Integer limit, @WebParam(name = "offset") Integer offset);

	int createCard(@WebParam(name = "cardType") Card cardType);

	boolean updateCard(@WebParam(name = "card") Card card);

	boolean deleteCard(@WebParam(name = "className") String className, @WebParam(name = "cardId") int cardId);

	int createLookup(@WebParam(name = "lookup") Lookup lookup);

	boolean deleteLookup(@WebParam(name = "lookupId") int lookupId);

	boolean updateLookup(@WebParam(name = "lookup") Lookup lookup);

	Lookup getLookupById(@WebParam(name = "id") int id);

	Lookup[] getLookupList(@WebParam(name = "type") String type, @WebParam(name = "value") String value,
			@WebParam(name = "parentList") boolean parentList);

	Lookup[] getLookupListByCode(@WebParam(name = "type") String type, @WebParam(name = "code") String code,
			@WebParam(name = "parentList") boolean parentList);

	boolean createRelation(@WebParam(name = "relation") Relation relation);

	boolean createRelationWithAttributes(@WebParam(name = "relation") Relation relation,
			@WebParam(name = "attributes") List<Attribute> attributes);

	boolean deleteRelation(@WebParam(name = "relation") Relation relation);

	List<Relation> getRelationList(@WebParam(name = "domain") String domain,
			@WebParam(name = "className") String className, @WebParam(name = "cardId") int cardId);

	List<RelationExt> getRelationListExt(@WebParam(name = "domain") String domain,
			@WebParam(name = "className") String className, @WebParam(name = "cardId") int cardId);
	...
	Attachment[] getAttachmentList(@WebParam(name = "className") String className,
			@WebParam(name = "cardId") int cardId);

	boolean uploadAttachment(@WebParam(name = "className") String className, @WebParam(name = "objectid") int objectid,
	...
	DataHandler downloadAttachment(@WebParam(name = "className") String className,
			@WebParam(name = "objectid") int objectid, @WebParam(name = "filename") String filename);

	boolean deleteAttachment(@WebParam(name = "className") String className, @WebParam(name = "cardId") int cardId,
			@WebParam(name = "filename") String filename);

	boolean updateAttachmentDescription(@WebParam(name = "className") String className,
			@WebParam(name = "cardId") int cardId, @WebParam(name = "filename") String filename,
			@WebParam(name = "description") String description);

	Workflow updateWorkflow(@WebParam(name = "card") Card card, @WebParam(name = "completeTask") boolean completeTask,
			@WebParam(name = "widgets") WorkflowWidgetSubmission[] widgets);

	String getProcessHelp(@WebParam(name = "classname") String classname, @WebParam(name = "cardid") Integer cardid);

	AttributeSchema[] getAttributeList(@WebParam(name = "className") String className);

	ActivitySchema getActivityObjects(@WebParam(name = "className") String className,
	...
	Report[] getReportList(@WebParam(name = "type") String type, @WebParam(name = "limit") int limit,
			@WebParam(name = "offset") int offset);

	AttributeSchema[] getReportParameters(@WebParam(name = "id") int id,
			@WebParam(name = "extension") String extension);

	@XmlMimeType("application/octet-stream")
	DataHandler getReport(@WebParam(name = "id") int id, @WebParam(name = "extension") String extension,
	...
	ClassSchema getClassSchemaByName(@WebParam(name = "className") String name,
			@WebParam(name = "includeAttributes") boolean includeAttributes);

	ClassSchema getClassSchemaById(@WebParam(name = "classId") long id,
			@WebParam(name = "includeAttributes") boolean includeAttributes);
	...
	Attribute[] callFunction(@WebParam(name = "functionName") String functionName,
