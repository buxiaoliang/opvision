...
public class Menu {
	...
	public MenuItemConverter menuItemConverter() {
		return new MenuItemConverter(data.systemDataView(), data.systemDataAccessLogic());
	}
	...
	private MenuElementConverter menuElementConverter() {
		return new MenuElementConverter(data.systemDataView(), user.userDataAccessLogic());
	}
