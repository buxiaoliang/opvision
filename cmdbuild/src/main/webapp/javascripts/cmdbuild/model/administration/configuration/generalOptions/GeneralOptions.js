(function () {
	...
	Ext.define('CMDBuild.model.administration.configuration.generalOptions.GeneralOptions', {
		...
		fields: [
			...
			{ name: CMDBuild.core.constants.Proxy.CSV_IMPORT_ONEBYONE, type: 'boolean' },
		...
		constructor: function (data) {
			...
			data[CMDBuild.core.constants.Proxy.CSV_IMPORT_ONEBYONE] = Ext.isBoolean(data[CMDBuild.core.constants.Proxy.CSV_IMPORT_ONEBYONE])
				? data[CMDBuild.core.constants.Proxy.CSV_IMPORT_ONEBYONE] : data['import_csv.one_by_one'];
			...
			data[CMDBuild.core.constants.Proxy.DISPLAY_CARD_LOCKER_NAME] = Ext.isBoolean(data[CMDBuild.core.constants.Proxy.DISPLAY_CARD_LOCKER_NAME])
				? data[CMDBuild.core.constants.Proxy.DISPLAY_CARD_LOCKER_NAME] : data['lockcarduservisible'];
			data[CMDBuild.core.constants.Proxy.ENABLE_CARD_LOCK] = Ext.isBoolean(data[CMDBuild.core.constants.Proxy.ENABLE_CARD_LOCK])
		...
		getParamsObject: function () {
			...
			return {
				'import_csv.one_by_one': data[CMDBuild.core.constants.Proxy.CSV_IMPORT_ONEBYONE],
