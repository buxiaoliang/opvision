(function () {
	...
	Ext.define('CMDBuild.model.common.Accordion', {
		...
		fields: [
			...
			{ name: CMDBuild.core.constants.Proxy.SOURCE_FUNCTION, type: 'auto' }, // used for view accordion
			{ name: CMDBuild.core.constants.Proxy.FILTER, type: 'auto' }, // used for view accordion
