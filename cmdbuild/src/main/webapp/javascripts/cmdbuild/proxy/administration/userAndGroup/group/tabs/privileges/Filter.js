(function () {
	...
	Ext.define('CMDBuild.proxy.administration.userAndGroup.group.tabs.privileges.Filter', {
		 ...
		 */
		getStore: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.GROUP_PRIVILEGE, {
				autoLoad: false,
		...
		update: function (parameters) {
			...
			CMDBuild.global.Cache.request(CMDBuild.core.constants.Proxy.GROUP_PRIVILEGE, parameters, true);
		}
	});
