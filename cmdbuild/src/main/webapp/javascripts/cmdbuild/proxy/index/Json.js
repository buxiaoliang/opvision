(function () {
	...
	Ext.define('CMDBuild.proxy.index.Json', {
		...
		card: {
			create: 'services/json/management/modcard/updatecard', // TODO: waiting for refactor (crud)
		...
		gis: {
			...
			getGISTreeNavigation: 'services/json/gis/getgistreenavigation',
		...
		workflow: {
			...
			activity: {
				create: 'services/json/workflow/saveactivity', // TODO: waiting for refactor (crud)
