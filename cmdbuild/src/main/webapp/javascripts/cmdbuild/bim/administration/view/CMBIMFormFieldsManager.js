(function() {
	...
	Ext.define('CMDBuild.delegate.administration.bim.CMBIMFormFieldsManager', {
		...
		build: function() {
			...
			this.fieldXmlMapping = Ext.create('Ext.form.field.File', {
				name: CMDBuild.core.constants.Proxy.IMPORT_MAPPING,
				fieldLabel: CMDBuild.Translation.mapping,
				labelWidth: CMDBuild.core.constants.FieldWidths.LABEL,
				width: CMDBuild.core.constants.FieldWidths.ADMINISTRATION_BIG
			});
			...
			var fields = [this.name, this.description, this.activeCheckBox, this.fileField, this.fieldXmlMapping, this.cardBinding, this.importIfcButton];
