(function () {
	...
	Ext.application({
		...
		launch: function () {
			...
			CMDBuild.proxy.utility.ChangePassword.readConfiguration({
				params: {},
				scope: this,
				success: function (response, options, decodedResponse) {
					helperText = decodedResponse.data['org.cmdbuild.config.password.helper-message'];
					
					this.mainViewport = Ext.create('CMDBuild.view.changePassword.MainViewport', {helper: helperText});
				}
			});
