			...
			Ext.apply(this, {
				...
				// OpenTabs widgets: they have to open a tab in the activityTabPanel, and not a separate window
					...
					'.OpenNote': function (widget, activity) {
						if (!Ext.isEmpty(me.tabbedWidgetDelegate) && !Ext.isEmpty(me.tabbedWidgetDelegate.getNotesPanel()))
...
//				|| (
//					!Ext.isEmpty(this.mainView.delegate)
//					&& !Ext.isEmpty(this.mainView.delegate.parentDelegate)
//					&& !Ext.isEmpty(this.mainView.delegate.parentDelegate.controllerTabEmail)
//					&& Ext.isFunction(this.mainView.delegate.parentDelegate.controllerTabEmail.reset)
//				)
//			) {
