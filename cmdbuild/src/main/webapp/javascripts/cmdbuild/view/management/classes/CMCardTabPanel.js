(function() {
	...
	Ext.define("CMDBuild.view.management.classes.CMCardTabPanel", {
		...
		/**
		 * @cfg {CMDBuild.controller.management.common.CMModController}
		 */
		delegate: undefined,
		frame: false,
		...
		getCardPanel: function() {
			if (!Ext.isEmpty(this.cardPanel2))
				return this.cardPanel2;
		...
		activateFirstTab: function() {
			if (!Ext.isEmpty(this.cardPanel2))
				this.setActiveTab(this.cardPanel2);
			else 
		...
		activeTabSet: function(tab) {
			...
			if (!Ext.isEmpty(this.cardPanel2))
				return this.setActiveTab(this.cardPanel2);
