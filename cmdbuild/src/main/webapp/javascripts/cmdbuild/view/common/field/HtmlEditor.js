(function () {
	...
	Ext.define('CMDBuild.view.common.field.HtmlEditor', {
		...
		initComponent: function () {
			...
			// Language setup
			var translationLabel = CMDBuild.configuration.runtime.get(CMDBuild.core.constants.Proxy.LANGUAGE).split('_');

			this.tinyMCEConfig.language = translationLabel.length > 1 ? translationLabel[0] : CMDBuild.configuration.runtime.get(CMDBuild.core.constants.Proxy.LANGUAGE);
