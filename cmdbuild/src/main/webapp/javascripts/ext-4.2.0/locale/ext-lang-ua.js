...
Ext.define("Ext.locale.ua.view.View", {
    override: "Ext.view.View",
    emptyText: "<Порожньо>"
});

Ext.define("Ext.locale.ua.grid.plugin.DragDrop", {
    override: "Ext.grid.plugin.DragDrop",
    dragText: "{0} обраних рядків"
});

Ext.define("Ext.locale.ua.tab.Tab", {
    override: "Ext.tab.Tab",
    closeText: "Закрити цю вкладку"
});

Ext.define("Ext.locale.ua.form.field.Base", {
    override: "Ext.form.field.Base",
    invalidText: "Хибне значення"
});

// changing the msg text below will affect the LoadMask
Ext.define("Ext.locale.ua.view.AbstractView", {
    override: "Ext.view.AbstractView",
    loadingText: "Завантаження..."
});

Ext.define("Ext.locale.ua.picker.Date", {
...
Ext.define("Ext.locale.ua.picker.Month", {
    override: "Ext.picker.Month",
    okText: "&#160;OK&#160;",
    cancelText: "Відміна"
});

Ext.define("Ext.locale.ua.toolbar.Paging", {
...
Ext.define("Ext.locale.ua.form.field.Text", {
...
Ext.define("Ext.locale.ua.form.field.Number", {
...
Ext.define("Ext.locale.ua.form.field.Date", {
...
Ext.define("Ext.locale.ua.form.field.ComboBox", {
...
Ext.define("Ext.locale.ua.form.field.VTypes", {
...
Ext.define("Ext.locale.ua.form.field.HtmlEditor", {
...
Ext.define("Ext.locale.ua.grid.header.Container", {
...
Ext.define("Ext.locale.ua.grid.PropertyColumnModel", {
...
Ext.define("Ext.locale.ua.window.MessageBox", {
...
Ext.define("Ext.locale.ua.Component", {	
