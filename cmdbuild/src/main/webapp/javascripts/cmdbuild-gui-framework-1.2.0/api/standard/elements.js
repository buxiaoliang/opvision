(function($) {
	var elements = {
		...
		checkbox : function(xmlElement) {
			...
			var formStr = " formName='" + formName + "' "
			var input = "<input type='checkbox'" + checked + ca + formStr + onClick + "value='" + text + "' />";
		...
		lookupDialog : function(id, param) {
			...
			xmlStr += "</params>";
			xmlStr += "<div id='" + id + "_dialogDiv' class='cmdbuild-dialog-content'>";
			xmlStr += "<onInit>";
			...
			xmlStr += "<cqlRefForm>" + param.cqlRefForm + "</cqlRefForm>";
			xmlStr += "<cqlRefField>" + param.cqlRefField + "</cqlRefField>";
			xmlStr += "</onInit>";
			...
			xmlStr += "<nRows>" + $.Cmdbuild.global.getApplicationConfig().grid.pagelength + "</nRows>";
			xmlStr += "<lookup>true</lookup>";
			xmlStr += "<navigation>false</navigation>";
			xmlStr += "<sort>" + param.sort ? param.sort : 'Description' + "</sort>";
			xmlStr += "<direction>" + param.direction ? param.direction : 'asc' + "</direction>";
			xmlStr += "</params>";
			xmlStr += "<onDblClick>";
			...
			xmlStr += "</form>";
			xmlStr += "</div>";
			xmlStr += "<div class='cmdbuild-dialog-footer'>";
